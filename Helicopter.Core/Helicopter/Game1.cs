...
namespace Helicopter.Core
{
	public class Game1 : Game
	{
		...
		public static bool rainbowOverlayEnabled = false;
        ...
        private void LoadAssets()
		{
			...
			Global.setPixel(base.GraphicsDevice);
		...
		public void UpdateChoreographyRon(float dt, float elapsedMilliseconds)
		{
			...
			if (elapsedMilliseconds > this.eventTimes[this.currEvent])
			{
				...
				case 0:
					...
					Camera.SetEffect(0); //index0 shakeblur
                    break;
				case 4:
				...
				case 6:
					...
					Camera.SetEffect(1); //index1 outline
					this.heartsManager.TurnOn();
					break;
				case 8:
					Camera.SetEffect(2); //index4 shakezigzag
					break;
				case 9:
					...
					break;
				case 10:
					Camera.SetEffect(5); //index2 circles
					this.tunnel.Set(TunnelEffect.Normal);
					break;
				case 11:
					Camera.SetEffect(4); //index3 wave
					break;
				case 12:
					Camera.SetEffect(1); //index1 outline
					this.heartsManager.TurnOn();
				...
				case 13:
					this.heartsManager.TurnOff();
					this.tunnel.Set(TunnelEffect.Disappear);
				    Camera.SetEffect(3); //index5 drunk
					this.dancerManager.TurnOn(0);
					break;
				case 14:
					this.tunnel.Set(TunnelEffect.Normal);
